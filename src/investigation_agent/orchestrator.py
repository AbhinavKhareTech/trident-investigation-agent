...
Usage:
    ...
    python -m investigation_agent.orchestrator

    # Watch a folder for new data
    python -m investigation_agent.orchestrator --watch ./incoming_data

    # Use existing data
    python -m investigation_agent.orchestrator --data ./my_data
"""
...
from investigation_agent.models import Severity, InvestigationPhase
